      ...
      <div className="relative container px-4 md:px-6 flex items-end min-h-screen pb-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
            <Button 
              size="lg" 
              className="bg-anthropic-book-cloth hover:bg-anthropic-kraft text-anthropic-ivory-light transition-colors px-8 py-6 text-lg"
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-anthropic-cloud-light text-anthropic-cloud-light hover:text-anthropic-ivory-light hover:bg-anthropic-cloud-dark/20 transition-colors px-8 py-6 text-lg"
